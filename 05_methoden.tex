...
\begin{table}[h!]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabulary}{1.3\textwidth}{C|C|C|C|C|C|C|C|C}
			\hline
			\multicolumn{2}{c|}{\textbf{Spindel}}  & \textbf{1} &\textbf{2}&\textbf{3}&\textbf{4}&\textbf{5}&\textbf{6}&\textbf{7}\\
			\hline
			 \textbf{Viskosität} & \textbf{\SI{20}{\rpm}} 					&$<$500&200-2000&500-5000&1000-10000&2000-20000&5000-50000&20000-200000\\
			 \cline{2-9}	
			 \textbf{in}& \textbf{\SI{50}{\rpm}} 							&$<$200&80-800&200-2000&400-4000&800-8000&2000-20000&8000-80000\\
			 \cline{2-9}	
			 \textbf{\si{\milli \pascal \second}}& \textbf{\SI{100}{\rpm}} 	&&&&&&&\\
			 \hline
	\end{tabulary}
}
\end{table}%
