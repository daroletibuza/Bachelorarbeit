...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\textwidth]{img/verdicker_struktur}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1.0\textwidth]{img/fluidarten}
	\caption{Rheologieprofile für verschiedene Fluide, erstellt nach \cite{Holze.2010, MunzingChemieGmbH.2018}}
	\label{fig: arten_fluide}
\end{figure}
\FloatBarrier


\subsubsection*{Bestimmung der dynamischen Viskosität nach }

\todo[inline]{Inhalt fehlt}
Die dynamische Viskosität $\eta$ ist definiert als das Verhältnis von Schubspannung $\tau$ zur Scherrate $D$.

Rotationsviskosimeter

\subsubsection*{Bestimmung der Dichte nach }
